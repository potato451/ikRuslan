 ...
 */
    ...
    private static Testing5 run(String in) {
        return run(in, true);
    }

    private static Testing5 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Testing5(clName, in, runMain);
    }
    ...
    private Testing5(String className, String in, boolean runMain) {
