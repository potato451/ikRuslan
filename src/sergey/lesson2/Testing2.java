 ...
 */
    ...
    private static Testing2 run(String in) {
        return run(in, true);
    }

    private static Testing2 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Testing2(clName, in, runMain);
    }
    ...
    private Testing2(String className, String in, boolean runMain) {
