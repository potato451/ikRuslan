...
class TaskA2 {
    public static  void main(String[] args){
        String a = "Ночевала тучка золотая на груди утеса-великана;";
        String b = "Утром в путь она умчалась рано, По лазури весело играя;";
        String c = "Но остался влажный след в морщине Старого утеса.";
        String d = " Одиноко Он стоит, задумался глубоко,";
        String e = "И тихонько плачет он в пустыне.";
