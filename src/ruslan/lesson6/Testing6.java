 ...
 */
    ...
    private static Testing6 run(String in) {
        return run(in, true);
    }

    private static Testing6 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Testing6(clName, in, runMain);
    }
    ...
    private Testing6(String className, String in, boolean runMain) {
